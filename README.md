...
- **Gerakkan Karakter:** Gunakan tombol `W`, `A`, `S`, `D` untuk bergerak ke segala arah.
- **Hindari Serangan:** Tekan `Spasi` untuk menghindar dan menghindari serangan musuh.
- **Serang Musuh:** Klik **kiri** pada mouse Anda untuk menyerang musuh.
